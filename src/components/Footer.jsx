...
import Location from '../assets/icon/icon-location.gif';
import CopyRight from '../assets/icon/icon-copyrights.png';
            ...
            <div className="content-footer">
                <div className='footer-mainContent'>
                    ...
                    <div className="copy-right">
                        <p> <img src={CopyRight} alt="" className='copyrght-img' /> Copyright {currentYear} by Nikola Zovko.</p>
                    </div>
